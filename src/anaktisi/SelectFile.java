...
public class SelectFile extends javax.swing.JFrame {
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        if(str.equals("CancelSelection")){
            JOptionPane.showMessageDialog(null, "Η εφαρμογή τερματίζει!", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
            System.exit(0);
        }
        else{
            JsonParser jp = new JsonParser(jFileChooser1);
                       
            try {
                ArrayList<String> reviews = jp.read(stars);
                if(reviews==null){
                    JOptionPane.showMessageDialog(null, "Παρακαλώ δώστε έγκυρο όνομα αρχείου", "InfoBox: ", JOptionPane.INFORMATION_MESSAGE);
                }
                else{
                    MyQuery q = new MyQuery(reviews,stars);
